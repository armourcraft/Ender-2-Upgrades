...
This repository is for my upgrades to the original Ender 2. This upgrade can use the existing main board or the BigTreeTech SKR Mini E3 v3 running either Marlin or Klipper. 
...
| :-------- | :---: | :---------- |
| M3x6 BHCS  | 12 | grill covers, psu mounts, psu riser |
...
| :---- | :---: | :----------- | :------ |
| V-Slot 2060 Extrusion 250mm | 2 | need +1mm for clearance | [Amazon](https://www.amazon.com/dp/B0D1KCGV5D) - came 251mm |
